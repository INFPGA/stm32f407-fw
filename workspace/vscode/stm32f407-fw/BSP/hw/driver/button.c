...
{
    {SW1_GPIO_Port, SW1_Pin, GPIO_PIN_RESET, NAME_DEF(BTN_SW1)},  // 0. BTN
    {SW2_GPIO_Port, SW2_Pin, GPIO_PIN_RESET, NAME_DEF(BTN_SW2)},
    {SW3_GPIO_Port, SW3_Pin, GPIO_PIN_RESET, NAME_DEF(BTN_SW3)},
};
